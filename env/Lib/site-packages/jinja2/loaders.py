...
class DictLoader(BaseLoader):
    ...
    >>> loader = DictLoader({'volunteers.html': 'source here'})
...
class PrefixLoader(BaseLoader):
    ...
    By loading ``'app1/volunteers.html'`` the file from the app1 package is loaded,
    by loading ``'app2/volunteers.html'`` the file from the second.
    """
